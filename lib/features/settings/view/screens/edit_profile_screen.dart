...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  Future<void> _pickResume() async {
    ...
    if (result != null && result.files.single.path != null) {
      await ref.read(profileNotifierProvider.notifier).uploadResume(File(result.files.single.path!));
    }
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
              ...
              children: [
                ...
                AppGlassCard(
                  child: Column(
                    children: [
                      GestureDetector(
                        onTap: state.isUploadingAvatar ? null : _pickImage,
                        child: Container(
                          width: 80.w,
                          height: 80.h,
                      ...
                      GestureDetector(
                        onTap: state.isUploadingAvatar ? null : _pickImage,
                        child: Text(
                          state.isUploadingAvatar ? 'Uploading...' : 'Change Avatar',
                          style: TextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppButton(
                        ...
                        onPressed: state.isUploadingResume ? null : _pickResume,
                      ),
                    ],
                  ),
                ),
          ...
          if (state.isLoading || state.isUploadingAvatar || state.isUploadingResume)
            Container(
